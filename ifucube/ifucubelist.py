...
# ifulist = IFUList.read('thefitsfile.fits')
# ifulist = IFUList.read('thefitsfile.asdf')
...
class IFUOLD:
    ...
    def __str__(self):
        """
        Write out information about the cube to the screen
        :return:
        """
    ...
    def display(self):
        """
        Write out information to teh screen
        :return:
        """
